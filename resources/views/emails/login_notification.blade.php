                ...
                <table role="presentation" width="100%" max-width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px 32px;">
                            <h2 style="font-size: 20px; font-weight: 600; color: #111827; margin-top: 0; margin-bottom: 16px; letter-spacing: -0.3px;">New Login Detected</h2>
                            ...
                            <p style="font-size: 16px; line-height: 24px; color: #4b5563; margin-top: 0; margin-bottom: 24px;">
                                We detected a successful login to your account. Here are the details of the session:
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 20px 24px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td style="padding: 6px 0; font-size: 14px; color: #6b7280; width: 100px; font-weight: 500;">Time</td>
                                                <td style="padding: 6px 0; font-size: 14px; color: #111827; font-weight: 600;">{{ $time }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 6px 0; font-size: 14px; color: #6b7280; width: 100px; font-weight: 500;">IP Address</td>
                                                <td style="padding: 6px 0; font-size: 14px; color: #111827; font-family: monospace; font-weight: 600;">{{ $ip }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 6px 0; font-size: 14px; color: #6b7280; width: 100px; font-weight: 500;">Device/OS</td>
                                                <td style="padding: 6px 0; font-size: 14px; color: #111827; font-weight: 600;">{{ $userAgent }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <!-- Security Alert -->
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #fef2f2; border-radius: 12px; border-left: 4px solid #ef4444; margin-bottom: 28px;">
                                <tr>
                                    <td style="padding: 16px 20px;">
                                        <p style="margin: 0; font-size: 14px; line-height: 20px; color: #991b1b; font-weight: 500;">
                                            <strong>Security Warning:</strong> If you did not log in just now, please secure your account immediately by changing your password.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="text-align: center; margin-top: 36px; margin-bottom: 12px;">
                                <a href="{{ route('profile.edit') }}" style="background-color: #4f46e5; color: #ffffff; padding: 12px 28px; font-size: 15px; font-weight: 600; text-decoration: none; border-radius: 8px; display: inline-block; transition: background-color 0.2s ease;">
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 24px; text-align: center; border-top: 1px solid #f3f4f6;">
                            <p style="margin: 0 0 8px 0; font-size: 12px; color: #9ca3af;">
                                You are receiving this because security notifications are active for your account.
                            </p>
