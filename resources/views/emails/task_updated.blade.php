                ...
                <table role="presentation" width="100%" max-width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px 32px;">
                            <h2 style="font-size: 20px; font-weight: 600; color: #111827; margin-top: 0; margin-bottom: 16px; letter-spacing: -0.3px;">Task Updated</h2>
                            ...
                            <p style="font-size: 16px; line-height: 24px; color: #4b5563; margin-top: 0; margin-bottom: 24px;">
                                The task <strong style="color: #111827;">"{{ $task->title }}"</strong> assigned to you has been updated by <strong style="color: #111827;">{{ $updaterName }}</strong>.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 20px 24px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            @if ($task->description)
                                                <tr>
                                                    <td style="padding: 6px 0; font-size: 14px; color: #6b7280; width: 100px; font-weight: 500; vertical-align: top;">Description</td>
                                                    <td style="padding: 6px 0; font-size: 14px; color: #111827; font-weight: 500; line-height: 20px;">{{ $task->description }}</td>
                                                </tr>
                                            @endif
                                            @if ($task->deadline)
                                                <tr>
                                                    <td style="padding: 6px 0; font-size: 14px; color: #6b7280; width: 100px; font-weight: 500;">Deadline</td>
                                                    <td style="padding: 6px 0; font-size: 14px; color: #b91c1c; font-weight: 600;">{{ \Carbon\Carbon::parse($task->deadline)->format('d M Y, H:i') }}</td>
                                                </tr>
                                            @endif
                                            <tr>
                                                <td style="padding: 6px 0; font-size: 14px; color: #6b7280; width: 100px; font-weight: 500;">Status</td>
                                                <td style="padding: 6px 0; font-size: 14px; color: #111827; font-weight: 600;">{{ ucfirst(str_replace('_', ' ', $task->status)) }}</td>
                                            </tr>
                                            @if ($task->category)
                                                <tr>
                                                    <td style="padding: 6px 0; font-size: 14px; color: #6b7280; width: 100px; font-weight: 500;">Category</td>
                                                    <td style="padding: 6px 0; font-size: 14px; color: #111827; font-weight: 600;">{{ $task->category->name }}</td>
                                                </tr>
                                            @endif
                                            @if ($task->team)
                                                <tr>
                                                    <td style="padding: 6px 0; font-size: 14px; color: #6b7280; width: 100px; font-weight: 500;">Team</td>
                                                    <td style="padding: 6px 0; font-size: 14px; color: #111827; font-weight: 600;">{{ $task->team->name }}</td>
                                                </tr>
                                            @endif
                                        </table>
                                    </td>
                            ...
                            <div style="text-align: center; margin-top: 36px; margin-bottom: 12px;">
                                <a href="{{ route('tasks.edit', $task->id) }}" style="background-color: #4f46e5; color: #ffffff; padding: 12px 28px; font-size: 15px; font-weight: 600; text-decoration: none; border-radius: 8px; display: inline-block; transition: background-color 0.2s ease;">
                                    View Task Details
                                </a>
                            </div>
                        </td>
