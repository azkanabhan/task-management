                ...
                <table role="presentation" width="100%" max-width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px 32px;">
                            <h2 style="font-size: 20px; font-weight: 600; color: #111827; margin-top: 0; margin-bottom: 16px; letter-spacing: -0.3px;">Role Updated in Team</h2>
                            ...
                            <p style="font-size: 16px; line-height: 24px; color: #4b5563; margin-top: 0; margin-bottom: 24px;">
                                Your role in team <strong style="color: #111827;">{{ $team->name }}</strong> has been updated to <strong style="color: #4f46e5; text-transform: uppercase;">{{ $role }}</strong>.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 20px 24px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="padding: 6px 0; font-size: 14px; color: #6b7280; width: 100px; font-weight: 500;">New Role</td>
                                                <td style="padding: 6px 0; font-size: 14px; color: #4f46e5; font-weight: 600;">{{ ucfirst($role) }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
