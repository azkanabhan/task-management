...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-rose-500 dark:border-rose-400 text-sm font-semibold leading-5 text-slate-900 dark:text-slate-100 focus:outline-none focus:border-rose-700 transition duration-150 ease-in-out'
