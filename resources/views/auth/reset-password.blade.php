        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <x-text-input id="email" class="block w-full pl-11" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" placeholder="you@example.com" />
                </div>
